    ...
    scg
      ...
      .addSubcommand((sc) =>
        sc
          ...
          .addStringOption((o) =>
            o.setName("bot-name").setDescription("The name the bot should make the alert posts with"),
          )
          .addStringOption((o) =>
            o
              .setName("bot-avatar-url")
              .setDescription("The url for the avatar the bot should make the alert posts with"),
          )
          .addStringOption((o) =>
            o
              .setName("embed-title-template")
              .setDescription("The title to be used in embed. Must include %s to be replaced with Twitch name."),
          )
          .addStringOption((o) =>
            o.setName("pre-embed-content").setDescription("The message to be posted before the embed."),
          )
          .addChannelOption((o) =>
            o
              .setName("channel")
      ...
      .addSubcommand((sc) =>
        sc
          .setName("unset")
          .setDescription("Unset specific config for twitch alerts. Mark config with true to unset it.")
          .addBooleanOption((o) =>
            o.setName("bot-name").setDescription("The name the bot should make the alert posts with"),
          )
          .addBooleanOption((o) =>
  ...
  .addSubcommandGroup((scg) =>
    scg
      ...
      .addSubcommand((sc) =>
        sc
          .setName("add")
          .setDescription("Subscribe to a twitch channel's online and offline events")
          .addStringOption((o) =>
            o.setName("twitch-channel").setDescription("The Twitch channel to subscribe to").setRequired(true),
          ),
      )
      .addSubcommand((sc) =>
        sc
          .setName("remove")
          .setDescription("Remove a Twitch channel subscription from this server")
          .addStringOption((o) =>
            o.setName("twitch-channel").setDescription("Unsubscribe from this Twitch channel").setRequired(true),
          ),
      )
...
const handler = async (interaction: ChatInputCommandInteraction<CacheType>) => {
  ...
  if (!guild) {
    await interaction.reply({
      content: "I can't do that! This command only works within a server/guild.",
